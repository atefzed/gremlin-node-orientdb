...
function Graph() {
    ...
    this.v = function(conn, coll, obj, filter, callback) {
        ...
        } else if (value === undefined && !filter && !callback) {
            callback = type;
    ...
    this.inV = function(conn, coll, obj, callback) {
        ...
        } else if (value === undefined && !callback) {
            callback = type;
    ...
    this.inE = function(conn, coll, obj, label, callback) {
        ...
        } else if (value === undefined && !label && !callback) {
            callback = type;
    ...
    this.interval = function(conn, coll, label, value1, value2, callback) {
        if (!label || value === undefined1 || value === undefined2)
            return callback({
                name: 'VALIDATION',
                message: 'Some arguments are missing!'
            });
    ...
    this.has = function(conn, coll, obj, type, callback) {
        ...
        } else if (!type && value === undefined && !callback) {
            callback = label;
        ...
        eORv(coll, function(e, r) {
            if (r === 'v') {
                ...
                if (typeof idV !== 'string' || typeof condition !== 'string' || typeof type !== 'string')
                    return callback('ARG1, ARG2 and ARG3 must be a strings!');
     ...
     * @return {T} [description]
     */
    this.linkBoth = function(conn, coll, idV, arrIdVs, labelE, callback) {
        eORv(coll, function(e, r) {
            if (r === 'v') {
                ...
                if (!(arrIdVs instanceof Array))
                    return callback('ARG2 must be an array of Ids!');
                if (typeof idV !== 'string' && typeof labelE !== 'string')
                    return callback('ARG1 and ARG3 must be a strings!');
    ...
    this.ifThenElse = function(conn, coll, type, idV, condition, attTrue, attFalse, callback) {
        ...
        if (typeof type !== 'string' || typeof idV !== 'string' || typeof condition !== 'string' || typeof attTrue !== 'string' || typeof attFalse !== 'string')
            return callback('ARG1, ARG2, ARG3, ARG4 and ARG5 must be a strings!');
